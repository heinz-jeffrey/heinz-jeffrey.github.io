...
consonant = (A("p") | A("b") | A("t") | A("d") | A("k") | A("ɡ") | A("m") | A("n") | A("ŋ") | A("f") | A("v") | A("θ") | A("ð") | A("s") | A("z") | A("ʃ") | A("ʒ") | A("h") | A("ʤ") | A("ʧ") | A("j") | A("w") | A("ɹ") | A("l")).optimize()
...
# all segments
sigmaStar = pynini.closure(vowel | consonant)
